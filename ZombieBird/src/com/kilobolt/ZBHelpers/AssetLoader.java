...
public class AssetLoader {
	...
	public static void load() {
		...
		prefs = Gdx.app.getPreferences("Burung Hantu");

		if (!prefs.contains("TinggiSkor")) {
			prefs.putInteger("TinggiSkor", 0);
		}
	}

	public static void setHighScore(int val) {
		prefs.putInteger("TinggiSkor", val);
		prefs.flush();
	}

	public static int getHighScore() {
		return prefs.getInteger("TinggiSkor");
	}
